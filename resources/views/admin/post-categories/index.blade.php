<x-layouts.admin title="أقسام المدونة">
...
<p class="mb-6 rounded-sm bg-stone-soft/60 p-4 text-sm leading-relaxed text-charcoal-soft">
    صفحة القسم تُفهرس فقط بعد أن تحتوي على مقال منشور واحد على الأقل — القسم
    الفارغ صفحة ضعيفة المحتوى ولا فائدة من إدراجها.
</p>

<div class="overflow-x-auto rounded-sm border border-stone bg-ivory">
    <table class="w-full min-w-[40rem] text-sm">
        <caption class="sr-only">قائمة أقسام المدونة</caption>
        <thead>
            <tr class="border-b border-stone bg-stone-soft/50 text-charcoal-soft">
                ...
                <th scope="col" class="px-5 py-3 text-start font-normal">عدد المقالات</th>
                ...
                <tr>
                    <td class="px-5 py-4">
                        ...
                        <span class="mt-1 block text-xs text-charcoal-soft" dir="ltr" style="text-align: start;">
                            /المدونة/{{ $category->slug }}
                        </span>
                    </td>
                    <td class="px-5 py-4 num">{{ $category->posts_count }}</td>
