...
class HomeController extends Controller
{
    ...
    {
        $seo = new SeoData(
            title: 'مكتب المحامي ريان الجهني | محاماة الأعمال والتحكيم والتوثيق في جدة',
            description: 'مكتب محاماة في جدة يعمل مع الشركات والمستثمرين وملّاك العقارات في محاماة الأعمال والتحكيم التجاري والتوثيق والتسجيل العيني للعقار.',
        );
